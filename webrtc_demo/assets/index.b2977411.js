...
function R$2(a, b, e, d, c) {
  ...
  if (h)
    return h = a, c = c(h), a = "" === d ? "." + Q$1(h, 0) : d, I$1(c) ? (e = "", null != a && (e = a.replace(P$1, "$&/") + "/"), R$2(c, b, e, "", function(a2) {
      return a2;
  ...
  if (I$1(a))
    ...
    for (a = f2.call(a), g = 0; !(k2 = a.next()).done; )
      k2 = k2.value, f2 = d + Q$1(k2, g++), h += R$2(k2, b, e, f2, c);
  else if ("object" === k2)
...
var BaseVisionMediaSource = function(_super) {
  __extends$5(BaseVisionMediaSource2, _super);
  function BaseVisionMediaSource2(visionMedia) {
    var _this = _super.call(this) || this;
    _this.visionMedia = visionMedia;
    return _this;
  }
  BaseVisionMediaSource2.prototype.requestFrame = function() {
  ...
  BaseVisionMediaSource2.prototype.dispose = function() {
    delete this.visionMedia;
  };
  BaseVisionMediaSource2.createAndInit = function(constraint) {
    throw new Error("need implement");
  };
  return BaseVisionMediaSource2;
}(events.exports.EventEmitter);
var BaseVideoSource = function(_super) {
  __extends$5(BaseVideoSource2, _super);
  function BaseVideoSource2() {
    var _this = _super.call(this, document.createElement("video")) || this;
    _this.video.muted = true;
    return _this;
  }
  Object.defineProperty(BaseVideoSource2.prototype, "video", {
    get: function() {
      return this.visionMedia;
    },
    enumerable: false,
    configurable: true
  });
  BaseVideoSource2.prototype.dispose = function() {
    _super.prototype.dispose.call(this);
  };
  return BaseVideoSource2;
}(BaseVisionMediaSource);
var BaseCanvasSource = function(_super) {
  __extends$5(BaseCanvasSource2, _super);
  function BaseCanvasSource2() {
    var _this = _super.call(this, document.createElement("canvas")) || this;
    _this.context2d = _this.canvas.getContext("2d");
    return _this;
  }
  Object.defineProperty(BaseCanvasSource2.prototype, "canvas", {
    get: function() {
      return this.visionMedia;
    },
    enumerable: false,
  ...
  BaseCanvasSource2.prototype.dispose = function() {
    this.context2d = void 0;
    _super.prototype.dispose.call(this);
  };
  return BaseCanvasSource2;
}(BaseVisionMediaSource);
...
var MixingVideoSource = function(_super) {
  __extends$4(MixingVideoSource2, _super);
  function MixingVideoSource2() {
    var _this = _super.call(this) || this;
    _this.drawing = false;
    _this.mixingConfigList = [];
    _this.context2d = _this.canvas.getContext("2d");
    document.body.append(_this.canvas);
    return _this;
  }
  MixingVideoSource2.prototype.init = function(params) {
    var _this = this;
    var _a2 = params.frameRate, frameRate = _a2 === void 0 ? 24 : _a2, _b = params.backgroundColor, backgroundColor = _b === void 0 ? "#000" : _b, width = params.width, height = params.height;
    ...
    this.renderTaskTimer = setInterval(function() {
      _this.requestFrame();
    }, 1e3 / frameRate);
  };
  MixingVideoSource2.prototype.updateMixingConfig = function(config) {
    this.mixingConfigList = config;
  };
  MixingVideoSource2.prototype.requestFrame = function() {
    return __awaiter$5(this, void 0, void 0, function() {
      var backgroundColor, list, i, sourceConfig;
        ...
        switch (_a2.label) {
          case 0:
            if (this.drawing)
              return [2];
            this.drawing = true;
            backgroundColor = (this.videoMixingParams || {}).backgroundColor;
            this.context2d.clearRect(0, 0, this.canvas.width, this.canvas.height);
            this.context2d.fillStyle = backgroundColor || "";
            this.context2d.fillRect(0, 0, this.canvas.width, this.canvas.height);
            list = this.mixingConfigList.sort(function(a, b) {
          ...
          case 1:
            if (!(i < list.length))
              return [3, 4];
            sourceConfig = list[i];
            return [4, sourceConfig.videoSource.requestFrame()];
          case 2:
            _a2.sent();
            try {
  ...
  MixingVideoSource2.prototype.renderSource = function(sourceConfig) {
    var rect = sourceConfig.rect, _a2 = sourceConfig.rotate, rotate = _a2 === void 0 ? 0 : _a2;
    this.context2d.save();
    var centerPointerX = rect.x + rect.width / 2;
    var centerPointerY = rect.y + rect.height / 2;
    this.context2d.translate(centerPointerX, centerPointerY);
    this.context2d.rotate(-rotate);
    this.context2d.drawImage(sourceConfig.videoSource.visionMedia, -rect.width / 2, -rect.height / 2, rect.width, rect.height);
    this.context2d.rotate(rotate);
    this.context2d.translate(-centerPointerX, -centerPointerY);
    this.context2d.restore();
  };
  MixingVideoSource2.prototype.dispose = function() {
  ...
  return MixingVideoSource2;
}(BaseCanvasSource);
function getTextSize(text, fonStyle) {
  var _a2;
  if (!text) {
    return {
      aspectRatio: 1,
  ...
  var result = context.font.match(/(?<fontSize>\d+)px/);
  var fontSize = Number((_a2 = result === null || result === void 0 ? void 0 : result.groups) === null || _a2 === void 0 ? void 0 : _a2.fontSize);
  if (isNaN(fontSize)) {
    fontSize = 12;
  }
  return {
...
function stringifyFontStyle(params) {
  var _a2 = params.fontSize, fontSize = _a2 === void 0 ? 10 : _a2, _b = params.fontFamily, fontFamily = _b === void 0 ? "sans-serif" : _b, fontWeight = params.fontWeight;
  var arr = ["".concat(fontSize, "px"), "".concat(fontFamily)];
  if (fontWeight) {
...
function getDefaultDrawTextParams() {
  return {
    fontSize: 10,
...
var TextSource = function(_super) {
  __extends$3(TextSource2, _super);
  function TextSource2(text, params) {
    var _this = _super.call(this) || this;
    _this.text = "";
    _this.size = {
      aspectRatio: 1,
    ...
    _this.params = getDefaultDrawTextParams();
    _this.setText(text || "", params);
    return _this;
  }
  TextSource2.prototype.setText = function(text, params) {
    this.text = text;
    this.params = __assign$1(__assign$1({}, this.params), params);
    var _a2 = getTextSize(text || "", stringifyFontStyle(this.params)), aspectRatio = _a2.aspectRatio, height = _a2.height, width = _a2.width;
    this.size = { aspectRatio, height, width };
    this.canvas.height = height;
    this.canvas.width = width;
    this.drawText();
  };
  TextSource2.prototype.drawText = function() {
    this.context2d.clearRect(0, 0, this.canvas.width, this.canvas.height);
    var fillStyle = this.params.fillStyle;
    if (fillStyle) {
  ...
  TextSource2.prototype.requestFrame = function() {
  ...
  TextSource2.measureText = function(text, fonStyle) {
    return getTextSize(text || "", fonStyle);
  };
  TextSource2.createAndInit = function(constraint) {
    return new TextSource2(constraint.text || "", constraint.params);
  };
  return TextSource2;
}(BaseCanvasSource);
...
var WebCameraVideoSource = function(_super) {
  __extends$2(WebCameraVideoSource2, _super);
  function WebCameraVideoSource2() {
    return _super.call(this) || this;
  }
  WebCameraVideoSource2.prototype.startCapture = function(constraints) {
  ...
  WebCameraVideoSource2.prototype.stopCapture = function() {
    var _a2;
    (_a2 = this.mediaStream) === null || _a2 === void 0 ? void 0 : _a2.getTracks().map(function(track) {
      track.stop();
    });
    this.mediaStream = void 0;
  };
  WebCameraVideoSource2.prototype.dispose = function() {
    this.stopCapture();
    delete this.mediaStream;
    _super.prototype.dispose.call(this);
  };
  WebCameraVideoSource2.getCameraList = function() {
    return __awaiter$3(this, void 0, void 0, function() {
      var list;
      return __generator$3(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            list = _a2.sent();
            return [2, list.filter(function(device) {
  ...
  WebCameraVideoSource2.requestUserMediaPermission = function() {
    return __awaiter$3(this, void 0, void 0, function() {
      var media;
      return __generator$3(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            media = _a2.sent();
            media === null || media === void 0 ? void 0 : media.getTracks().map(function(track) {
              track.stop();
            });
            return [2];
        }
  ...
  WebCameraVideoSource2.createAndInit = function(constraint) {
    var source = new WebCameraVideoSource2();
    source.startCapture(constraint);
    return source;
  };
  return WebCameraVideoSource2;
}(BaseVideoSource);
...
var WebDisplayVideoSource = function(_super) {
  __extends$1(WebDisplayVideoSource2, _super);
  function WebDisplayVideoSource2() {
    return _super.call(this) || this;
  }
  WebDisplayVideoSource2.prototype.startCapture = function(media) {
    this.mediaStream = media;
    this.video.srcObject = media;
    this.video.play();
  };
  WebDisplayVideoSource2.prototype.stopCapture = function() {
    var _a2;
    (_a2 = this.mediaStream) === null || _a2 === void 0 ? void 0 : _a2.getTracks().map(function(track) {
      track.stop();
    });
  ...
  WebDisplayVideoSource2.prototype.dispose = function() {
    this.stopCapture();
    delete this.mediaStream;
    _super.prototype.dispose.call(this);
  };
  WebDisplayVideoSource2.getDisplayMediaStream = function() {
    return __awaiter$2(this, void 0, void 0, function() {
      function dispose() {
        video.srcObject = null;
      }
      var mediaStream, video;
  ...
  WebDisplayVideoSource2.createAndInit = function(constraint) {
    var source = new WebDisplayVideoSource2();
...
var WebImageSource = function(_super) {
  __extends(WebImageSource2, _super);
  function WebImageSource2(src2) {
    var _this = _super.call(this) || this;
    _this.image = document.createElement("img");
    if (src2) {
      _this.setImageSrc(src2);
    }
    return _this;
  }
  WebImageSource2.prototype.requestFrame = function() {
    var _a2;
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(_b) {
        (_a2 = this.context2d) === null || _a2 === void 0 ? void 0 : _a2.drawImage(this.image, 0, 0, this.canvas.width, this.canvas.height);
        return [2];
      });
    });
  };
  WebImageSource2.prototype.setImageSrc = function(src2) {
    var _this = this;
    this.image.src = src2;
    getImageSize(this.image).then(function(size) {
      _this.size = size;
      _this.canvas.width = size.width;
      _this.canvas.height = size.height;
    });
  };
  WebImageSource2.measureImage = function(src2) {
    var img = new Image();
    img.src = src2;
    return getImageSize(img);
  };
  WebImageSource2.createAndInit = function(constraint) {
    var source = new WebImageSource2(constraint.src || "");
    return source;
  };
  return WebImageSource2;
}(BaseCanvasSource);
...
var _a;
var WebVisionSourceType;
(function(WebVisionSourceType2) {
  WebVisionSourceType2["webcamera"] = "webcamera";
  WebVisionSourceType2["webdisplay"] = "webdisplay";
  WebVisionSourceType2["webimage"] = "webimage";
  WebVisionSourceType2["text"] = "text";
})(WebVisionSourceType || (WebVisionSourceType = {}));
var SouceContructorProvider = (_a = {}, _a[WebVisionSourceType.webcamera] = WebCameraVideoSource, _a[WebVisionSourceType.webimage] = WebImageSource, _a[WebVisionSourceType.text] = TextSource, _a[WebVisionSourceType.webdisplay] = WebDisplayVideoSource, _a);
var WebRtc = function() {
  function WebRtc2() {
    this.mixingVideoSource = new MixingVideoSource();
    this.sourceList = [];
    this.mixingConfigMap = /* @__PURE__ */ new Map();
  }
  WebRtc2.prototype.init = function(config) {
    this.mixingVideoSource.init(config);
    WebCameraVideoSource.requestUserMediaPermission();
  };
  WebRtc2.prototype.initLocalView = function(container) {
    container.innerHTML = "";
    container.appendChild(this.mixingVideoSource.visionMedia);
  };
  WebRtc2.prototype.getCameraList = function() {
    return WebCameraVideoSource.getCameraList();
  };
  WebRtc2.prototype.measureImage = function(src2) {
    return WebImageSource.measureImage(src2);
  };
  WebRtc2.prototype.measureText = function(text, fonStyle) {
    return TextSource.measureText(text, fonStyle);
  };
  WebRtc2.prototype.getDisplayMediaStream = function() {
    return WebDisplayVideoSource.getDisplayMediaStream();
  };
  WebRtc2.prototype.updateSourceList = function(sourceList) {
    var _this = this;
    var newMixingConfigMap = /* @__PURE__ */ new Map();
    sourceList.forEach(function(item) {
      var key = "".concat(item.deviceId, "-").concat(JSON.stringify(item.constraint));
      if (_this.mixingConfigMap.has(key)) {
        newMixingConfigMap.set(key, __assign(__assign({}, _this.mixingConfigMap.get(key)), item));
        _this.mixingConfigMap.delete(key);
      } else {
        var source = _this.createMideaSource(item);
        newMixingConfigMap.set(key, __assign({ videoSource: source }, item));
      }
    });
    this.mixingConfigMap.forEach(function(item) {
      item.videoSource.dispose();
    });
    this.mixingConfigMap.clear();
    this.mixingConfigMap = newMixingConfigMap;
    this.sourceList = sourceList;
    var mixingConfig = Array.from(newMixingConfigMap).map(function(item) {
      return item[1];
    });
    this.mixingVideoSource.updateMixingConfig(mixingConfig);
  };
  WebRtc2.prototype.createMideaSource = function(sourceConfig) {
    var _a2, _b;
    var constraint = __assign({}, sourceConfig.constraint);
    if (sourceConfig.sourceType === WebVisionSourceType.text && constraint.params) {
      constraint.params.fontSize = constraint.params.fontSize || sourceConfig.rect.height;
    }
    return (_b = (_a2 = SouceContructorProvider[sourceConfig.sourceType]).createAndInit) === null || _b === void 0 ? void 0 : _b.call(_a2, sourceConfig.constraint);
  };
  return WebRtc2;
}();
function useNovaRtc(config) {
  const containerRef = react.exports.useRef(null);
  const webRtcRef = react.exports.useRef();
...
var App$1 = "";
const src = "https://picx.zhimg.com/v2-3b4fc7e3a1195a081d0259246c38debc_1440w.jpg?source=172ae18b";
function useSourceManager(webRtcRef) {
  ...
  function removeSource(id2) {
    const idx = list.findIndex((item) => item.deviceId === id2);
    if (idx >= 0) {
      const newList = [...list];
...
function useAutoRef(target) {
  const ref = react.exports.useRef(target);
  ref.current = target;
  return ref;
}
...
function ResizeDot(props) {
  ...
  const startPos = react.exports.useRef({
    x: -1,
    y: -1
  });
  react.exports.useEffect(() => {
    const fn = lodash.exports.throttle((e) => {
      var _a2;
      ...
      (_a2 = onMoveRef.current) == null ? void 0 : _a2.call(onMoveRef, deltX, deltY);
    }, 100, {
      trailing: true
    });
  ...
  const stopPressing = react.exports.useCallback(() => {
  ...
  const onMouseDown = react.exports.useCallback((e) => {
...
function DragableRect(props) {
  ...
  react.exports.useEffect(() => {
    const fn = lodash.exports.throttle((e) => {
      ...
      startPos.current.x = e.clientX;
      startPos.current.y = e.clientY;
      (_a2 = onLayoutRef.current) == null ? void 0 : _a2.call(onLayoutRef, newRect);
    }, 50, {
      leading: false
    });
    document.body.addEventListener("mousemove", fn, true);
  ...
  const onMouseDown = react.exports.useCallback((e) => {
    var _a2;
    if ((_a2 = e.nativeEvent.target) == null ? void 0 : _a2.classList.contains("dragable-rect-dot")) {
      return;
    }
    isPressing.current = true;
    startPos.current = {
  ...
  const onDotMove = (dotOption, deltaX, deltaY) => {
    if (!rectRef.current || !onLayoutRef.current)
      return;
    const {
      x: x2,
      y: y2,
    ...
    onLayoutRef.current({
      ...
      height: height + dh2 * deltaY
    });
  };
  const dotSizeStyle = react.exports.useMemo(() => {
    return {
      height: `${8 / scale}px`,
      width: `${8 / scale}px`
    };
  ...
  return /* @__PURE__ */ jsx("div", {
    ...
    onClick: handleClick,
    onMouseDown,
    children: dotOptions.map((item) => /* @__PURE__ */ jsx(ResizeDot, {
      onMove: (x2, y2) => onDotMove(item, x2, y2),
      className: item.clsn,
      style: dotSizeStyle
    }, item.clsn))
  });
...
function App() {
  ...
  const {
    ...
    width: outputSize2.width,
    height: outputSize2.height,
    frameRate
  });
  const {
    updateSource,
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("h2", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [list == null ? void 0 : list.map((item) => /* @__PURE__ */ jsx(DragableRect, {
          ...
          scale,
          order: item.order
        }, item.deviceId)), /* @__PURE__ */ jsx("div", {
          ref: containerRef,
          children: " "
        })]
      })
